...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('mail_accounts', function (Blueprint $table) {
            ...
            $table->unsignedInteger('quota_mb')->nullable()->comment('Mailbox quota in MB, null = unlimited');
            $table->boolean('is_active')->default(true)->index();
            $table->foreignId('group_id')->nullable()->constrained('mail_groups')->nullOnDelete();
            $table->timestamps();
        });
