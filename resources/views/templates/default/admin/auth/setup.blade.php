...
<head>
    ...
    <title>First-run Setup — Opterius Mail</title>
...
<body class="min-h-screen bg-gray-900 flex items-center justify-center">
    <div class="w-full max-w-sm px-4">
        <div class="text-center mb-8">
            ...
            <p class="text-sm text-gray-400 mt-1">First-run setup &mdash; Opterius Mail</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.setup.submit') }}">
                ...
                <div class="mb-4">
                    ...
                    <input id="name" name="name" type="text" required value="{{ old('name') }}"
                           class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent @error('name') border-red-500 @enderror">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input id="password" name="password" type="password" required
                           class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-sm text-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent @error('password') border-red-500 @enderror">
                </div>
