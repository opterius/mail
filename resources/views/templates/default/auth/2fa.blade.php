...
<div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
    ...
    <form method="POST" action="{{ route('2fa.verify') }}">
        @csrf
        <div class="mb-6">
            <label for="code" class="block text-sm font-medium text-gray-700 mb-1">Authentication code or recovery code</label>
            ...
            <p class="text-xs text-gray-400 mt-1 text-center">Enter the 6-digit code from your authenticator app, or a recovery code.</p>
        </div>
        <button type="submit"
